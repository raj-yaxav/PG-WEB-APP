...
export const getManagerReports = (params = {}) => api.get("/reports", { params });
export const createManagerReport = (data) => api.post("/reports", data);
export const updateManagerReportStatus = (id, status, ownerNote = "") =>
  api.patch(`/reports/${id}/status`, { status, ownerNote });
